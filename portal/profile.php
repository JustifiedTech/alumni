        ...
        <div class="container-fluid">
            ...
            <div class="row">
            	<div class="col-md-2">
            		...
            		<img style="height:15rem;" class="" src="../uploads/<?php echo $image ?>">
            	</fieldset>
            	</div>
            	<div class="col-md-9 offset-1">
            		...
            		<fieldset style="border: .05rem dotted blue; ">
            			...
            			<tr class="">
            				<th bgcolor="#024" class="text-white">Name:</th> <td class="text-lg"><?php echo $last_name." ".$first_name." ".$other_name; ?></td>
            			</tr>
